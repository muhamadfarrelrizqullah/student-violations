    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <div class="mb-0" id="home">
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                {{-- style="background-image: url(assets/media/svg/illustrations/Land.svg)"--}}> 
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <a href="/">
                                    <img alt="Logo" src="assets/media/logos/landing.png"
                                        class="logo-default h-20px h-lg-30px" />
                                    <img alt="Logo" src="assets/media/logos/landing-dark.png"
                                        class="logo-sticky h-20px h-lg-30px" />
                                </a>
                            </div>
                ...
                <div class="container">
                    <div class="text-center mt-15 mb-18" id="achievements"
                        ...
                        <div class="fs-5 text-gray-700 fw-bold">Save thousands to millions of bucks by using single
                            tool <br />for different amazing and great useful admin</div>
                    </div>
                    ...
                    <div class="fs-2 fw-semibold text-muted text-center mb-3">
                        ...
                        about it in a <br />
                        <span class="text-gray-700 me-1">more powerful</span>, emotionally expressive way <span
        ...
        <div class="mt-20 mb-n20 position-relative z-index-2">
            <div class="container">
                ...
                <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13"
                    ...
                    <div class="my-2 me-5">
                        <div class="fs-1 fs-lg-2qx fw-bold text-white mb-2">Start With Metronic Today, <span
                                class="fw-normal">Speed Up Development!</span></div>
